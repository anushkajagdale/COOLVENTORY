...
const dbConfig = {
    ...
    database: process.env.MYSQLDATABASE || 'coolventory',
...
async function initializeDatabase() {
    try {
        // For Railway/production, database should already exist
        // For local development, try to create if it doesn't exist
        ...
        console.log('\nTo fix:');
        console.log('1. Verify MySQL connection details');
        console.log('2. For Railway: ensure database exists and credentials are correct');
        console.log('3. For local: ensure MySQL is running');
        process.exit(1);
    }
}
